...
import { Flower2, UtensilsCrossed, Lightbulb } from 'lucide-react';
...
const DesignSection = () => {
  ...
  const designElements = [
    ...
    { icon: UtensilsCrossed, label: 'Tablescapes' },
    { icon: Lightbulb, label: 'Lighting' },
  ];

  return (
    <section ref={sectionRef} className="section-pinned bg-black z-[80]">
      ...
      <div ref={imgTRRef} className="collage-card will-change-transform" style={{ left: '52vw', top: '10vh', width: '42vw', height: '34vh' }}>
        <img src="/hero_detail_flowers.jpg" alt="Floral details" className="w-full h-full object-cover" />
      </div>
      ...
      <div ref={textRef} className="text-block will-change-transform" style={{ left: '8vw', top: '58vh', width: '40vw' }}>
        <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight">
          Timeless<br /><span className="italic text-gold">design</span>
        </h2>
        <p className="text-white/60 text-lg leading-relaxed max-w-md">
          Typography, florals, tablescapes, and light—composed with restraint so the memory stays elegant forever.
        </p>
      </div>
