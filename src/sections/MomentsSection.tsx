...
const MomentsSection = () => {
  ...
  return (
    <section ref={sectionRef} className="section-pinned bg-black z-[70]">
      ...
      <div ref={textRef} className="text-block will-change-transform" style={{ left: '54vw', top: '62vh', width: '38vw' }}>
        <h2 className="font-serif text-4xl md:text-5xl lg:text-6xl text-white mb-4 leading-tight">
          Moments that<br /><span className="italic text-gold">breathe</span>
        </h2>
        <p className="text-white/60 text-lg leading-relaxed max-w-md">
          We design space for the unscripted: laughter, happy tears, and the light that only real connection creates.
        </p>
      </div>
    </section>
  );
